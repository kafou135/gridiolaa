...
export default function TaylorSwiftTrend() {
  return (
    <main style={{
      ...
      <h1 style={{ fontSize: '2.8rem', color: '#0c0c0cff', marginBottom: '15px' }}>
        🎤 Taylor Swift Drops New Album: <br /> <em>The Life of a Showgirl</em>
      </h1>

      <section style={{ marginBottom: '25px' }}>
        <h2 style={{ fontSize: '1.6rem', color: '#070607ff' }}>Announcement Details</h2>
        <p>
      ...
      <section style={{ marginBottom: '25px' }}>
        <h2 style={{ fontSize: '1.6rem', color: '#0a090aff' }}>Album Theme & Collaborations</h2>
        <ul>
      ...
      <section style={{ marginBottom: '25px' }}>
        <h2 style={{ fontSize: '1.6rem', color: '#080708ff' }}>Release Info</h2>
        <p>
      ...
      <section style={{ marginBottom: '25px' }}>
        <h2 style={{ fontSize: '1.6rem', color: '#0d0b0eff' }}>Why This Matters</h2>
        <p>
